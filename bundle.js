(() => {
  ...
  var require_sweetalert2_all = __commonJS((exports, module) => {
    ...
    */
    (function(global, factory) {
      ...
      var hideAllIcons = function hideAllIcons2() {
        var icons = getIcons();
      ...
      function mixin(mixinParams) {
        var MixinSwal = /* @__PURE__ */ function(_this) {
          ...
          _createClass(MixinSwal2, [{
            key: "_main",
            value: function _main2(params, prevMixinParams) {
              return _get(_getPrototypeOf(MixinSwal2.prototype), "_main", this).call(this, params, _extends({}, prevMixinParams, mixinParams));
            }
          }]);
          return MixinSwal2;
        }(this);
      ...
      var restoreActiveElement = function restoreActiveElement2() {
        return new Promise(function(resolve) {
      ...
      var animatePopup = function animatePopup2(instance, popup, container, didClose) {
  ...
  var require_sweetalert2_react_content_umd = __commonJS((exports, module) => {
    /** @preserve
  ...
  var MySwal = import_sweetalert2_react_content.default(import_sweetalert2.default);
